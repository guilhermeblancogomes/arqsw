...
<body>
    ...
    <div id="main" class="container">
        <h3 class="page-header">Fechar Chamados da Fila de espera ${fila.nome}</h3>
        <c:if test="${not empty chamados}">
            <p>Selecione os chamados para fechar.</p>
        ...
        <c:if test="${empty chamados}">
        	<div class="alert alert-info" role="alert">N&atilde;o h&aacute; Chamados em fila.</div>
